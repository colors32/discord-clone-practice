...
import { collection, CollectionReference, DocumentData, addDoc, serverTimestamp, DocumentReference, onSnapshot, Timestamp, query, orderBy } from 'firebase/firestore';
...
const Chat = () => {
  ...
  const sendMessage = async (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    ...
    const collectionRef: CollectionReference<DocumentData, DocumentData> = collection(db, "channels", String(channelId), "messages");
